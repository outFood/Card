<template>
  <div id="regist">
    ...
    <form action="#">
      ...
      <div class="item">
        <span>邀请人</span>
        <div><input placeholder="请填写姓名"></div>
      </div>
      <div class="item">
        <span>邀请人ID</span>
        <div><input placeholder="请填写邀请人ID"></div>
      </div>
      <div class="item">
        <span>姓名</span>
        <div><i>*</i><input placeholder="请填写真实姓名，用于结算"></div>
      </div>
      <div class="item">
        <span>手机号</span>
        <div><i>*</i><input placeholder="请填写手机号，方便联系"></div>
      </div>
      ...
      <yd-button size="large" type="danger">申请成为会员</yd-button>
      ...
      <div class="zhu">
        <p>*注: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam autem quasi quo. Accusamus aperiam architecto dolor fugiat incidunt ipsa minima, molestias nesciunt officiis quae quo, repellat reprehenderit, unde velit voluptatem.</p>
      </div>
    </form>
  </div>
</template>
